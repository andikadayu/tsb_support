                      ...
                      <tbody>
                        ...
                        <tr>                         
                          ...
                          <td class="td-actions text-right">
                            ...
                            <button onclick="get_data({{$data->id_user}})" type="button" rel="tooltip" class="btn btn-success btn-round" data-toggle="modal" data-target="#editUser" data-original-title="Edit Data" title="Edit Data">
                              <i class="material-icons">edit</i>
                            </button>                            
                            <button onclick="delete_user({{$data->id_user}})" type="button" rel="tooltip" class="btn btn-danger btn-round"  data-original-title="Delete Data" title="Delete Data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group bmd-form-group">
                        <div class="input-group">
                          ...
                          <select name="edit_role" id="edit_role" class="selectpicker" data-style="btn btn-info" title="Role">
